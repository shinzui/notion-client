...
4. "Date range condition": `MNLastEditedTime (MNDateIsWithin (MeetingNotesDateRange MNRelative (MNDateRangeText "today") (Just MNPast) (Just MNWeek) (Just 2)))` encodes `value` to `{"type":"relative","value":"today","direction":"past","unit":"week","count":2}`; with `MNDateRangeSpec "2026-09-01" Nothing` and the three optionals `Nothing`, `value` is `{"type":"exact","value":{"type":"daterange","start_date":"2026-09-01"}}`.
